...
class Review(BaseModel):
    ...
    sentiment: Literal["positives", "negatives"] = Field(description="Return sentiment of the review, either "
                                                                     "positive, negative or neutral")
    pros: Optional[list[str]] = Field(default=None, description="Write down all the pros mentioned in the review in a "
                                                                "list")
    cons: Optional[list[str]] = Field(default=None, description="Write down all the cons mentioned in the review in a "
                                                                "list")
